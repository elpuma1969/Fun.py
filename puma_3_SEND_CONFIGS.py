...
def run_script():
    ...
    for device_ip in devices_list:
        try:
            ...
            config_commands = ['int range fa1/10 - 15', 'no shut', 'switchport mode trunk',
                               'switchport trunk allowed vlan all', 'end', 'wr']
            ...
            output_directory = os.path.join(application_path, 'BACKUP_SCH', 'Trunk')
            ...
            print(f'An error occurred while processing device {device_ip}: {str(e)}')
            print('#' * 30)
